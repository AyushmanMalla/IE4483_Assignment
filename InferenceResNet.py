...
NUM_WORKERS = 8      # Adjust for your HPC environment
MLP_HIDDEN = 512     # Must match the hidden layer size from training
...
# --- 3. Model Setup ---
# Re-define the ResNetMLP model architecture exactly as in your training script
class ResNetMLP(nn.Module):
    def __init__(self, num_classes=2):
        super().__init__()
        # Load the ResNet-50 architecture without pretrained weights
...
model = ResNetMLP(num_classes=len(class_to_idx))
